...
def main() -> int:
    ...
    if args.browser or args.storage:
        ...
        commands += [[sys.executable, 'tests/'+name] for name in ['browser.test.py','edge.test.py','soundcheck.browser.py','strings.browser.py','workshop.browser.py','smart-import.browser.py','chords.browser.py','hardware.browser.py','onboarding.browser.py','chord-stage.browser.py']]
    if args.storage:
