...
(function(root){
  ...
  class Controller {
    constructor({getContext,beforeOpen=()=>{},onMIDI=()=>{},onUseAudio=()=>{},getGameSettings=()=>({}),getMIDI=()=>[]}={}) {
      this.getGameSettings=getGameSettings;this.onUseAudio=onUseAudio;this.beforeOpen=beforeOpen;this.onMIDI=onMIDI;this.getMIDI=getMIDI;this.devices=[];this.status={};this.details={};this.scanSerial=0;
    ...
    renderCards(){
      ...
      for(const role of roles){
        ...
        $(`${role}Use`).onclick=()=>{if(!this.settings[role].device){this.notice("Choose an audio input before enabling live play.",true);return;}this.onUseAudio(role);};
