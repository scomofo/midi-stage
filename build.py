...
scripts = '\n'.join((root / 'src' / name).read_text() for name in ['core.js', 'chords.js', 'midi.js', 'hardware.js', 'onboarding.js', 'audio.js', 'input.js', 'strings.js', 'soundcheck.js', 'workshop.js', 'song-analysis.js', 'workshop-ui.js', 'app.js'])
